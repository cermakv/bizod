...
function lgraph = createUnet(inputTileSize,cnt)
%cnt - count of classes
...
finalConv = convolution2dLayer(1,cnt,...
    'BiasL2Factor',0,...
    'Name','Final-ConvolutionLayer');

finalConv.Weights = randn(1,1,decoderNumChannels,cnt);
finalConv.Bias = randn(1,1,cnt)*0.00001 + 1;
